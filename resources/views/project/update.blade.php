  ...
  <div class="">
    <div class="page-title">
      <div class="title_left">
        <h3 style="font-size:30px"><i class="fa fa-plus-square"></i> Update Your Project Idea</h3>
      </div>
    </div>
            ...
            <form id = "form" class="form-horizontal form-label-left" novalidate action="" method="POST" enctype="multipart/form-data">
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="project_name" name="namaproject" required="required" class="form-control col-md-7 col-xs-12" value="{{$project->namaproject}}">
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="alasan" name="alasan" required="required" class="form-control col-md-7 col-xs-12" style="height: 100px">{{$project->alasan}}</textarea>
                </div>
              </div>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" >Project Plan <span class="required">*</span> <br> <small> Describe my Project</small>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="deskripsi" name="deskripsi" required="required" class="form-control col-md-7 col-xs-12" style="height: 100px">{{$project->deskripsi}}</textarea>
                </div>
              </div>

              <div class="item form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12" >Strategic Intention <span class="required">*</span> <br> <small> Describe my Project</small>
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                    <textarea id="intention" name="intention" required="required" class="form-control col-md-7 col-xs-12" style="height: 100px">{{$project->intention}}</textarea>
                </div>
              </div>
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <input type="text" id="mentor" name="mentor" required="required" class="form-control col-md-7 col-xs-12" value="{{$project->mentor}}">
                </div>
              </div>
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <select class="form-control" name="sponsor_id">
                    @foreach($mentors as $mentor)
                      @if($project->sponsor_id == $mentor->id)
                        <option value="{{$mentor->id}}" selected="">{{$mentor->nama}}</option>
                      @else
              ...
              <div class="item form-group">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12">
                 <input class="form-control" type="file" name="datafile" ><br>
                 <a href="{{URL::to('budget/'.$project->budgetperkiraan)}}" data-toggle="tooltip" title="Download" class = "btn btn-primary" download><i style = "color:white" class="fa fa-download"></i> Download Current Budget Plan File</a>
                </div>
              </div>
              ...
              <div>
                <input type="hidden" id="sumOfGoods" name="sumOfGoods" value="{{$res_sum}}">
                <div id="hr">
                  <?php $a = 1;?>
                  @foreach ($resources as $res)
                    <div class="" id="row{{$a}}">
                      <button class="col-md-1 btn btn-danger" id="del{{$a}}" value="{{$a}}" onclick="removeRow(this)">Remove</button>
                      <label class="control-label col-md-1" id="person{{$a}}" >Person {{$a}} <span class="required">*</span></label>
                      <div class="item col-md-9">
                        <div class="item form-group col-md-6">
                          <div class="col-md-12">
                            <center><span><b>Job Spesification</b><span class="required">*</span></center>
                            <div class="x_content">
                              <textarea name="js{{$a}}" id="js{{$a}}">{{$res->jobspec}}</textarea>
                            </div>
                          </div>
                        </div>
                        <div class="item form-group col-md-6">
                          <div class="col-md-12">
                            ...
                            <div class="x_content">
                              <textarea name="jd{{$a}}" id="jd{{$a}}">{{$res->jobdesk}}</textarea>
                            </div>
                          </div>
                        </div>
                        <script type="text/javascript">
                          var a = {{$a}};
                          CKEDITOR.replace( 'js'+a );
                          CKEDITOR.replace( 'jd'+a );
                        </script>
                      </div>
                    </div>
                    <?php $a++;?>
                  ...
                  <div class="item form-group col-md-8">
                    <div class="col-md-9">
                      <div class="input-prepend input-group">
                        ...
                        <input type="text" style="width: 200px" name="reservation1" id="reservation" class="form-control"  value="{{$tgls[0]}}"/>
                      </div>
                      <span> What need to be done?<span class="required">*</span>
                      <div class="x_content">
                        <textarea name="descr1" id="descr1" required="required">{{$desc[0]}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 item form-group" >
                  ...
                  <div class="item form-group col-md-8">
                    <div class="col-md-9">
                      <div class="input-prepend input-group">
                        <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                        <input type="text" style="width: 200px" name="reservation2" id="reservation2" class="form-control"  value="{{$tgls[1]}}"/>
                      </div>
                      <span> What need to be done?<span class="required">*</span>
                      <div class="x_content">
                        <textarea name="descr2" id="descr2" required="required" >{{$desc[1]}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 item form-group">
                  ...
                  <div class="item form-group col-md-8">
                    <div class="col-md-9">
                      <div class="input-prepend input-group">
                        <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                        <input type="text" style="width: 200px" name="reservation3" id="reservation3" class="form-control"  value="{{$tgls[2]}}"/>
                      </div>
                      <span> What need to be done?<span class="required">*</span>
                      <div class="x_content">
                        <textarea name="descr3" id="descr3" required="required" >{{$desc[2]}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col-md-12 item form-group">
                  ...
                  <div class="item form-group col-md-8">
                    <div class="col-md-9">
                      <div class="input-prepend input-group">
                        <span class="add-on input-group-addon"><i class="glyphicon glyphicon-calendar fa fa-calendar"></i></span>
                        <input type="text" style="width: 200px" name="reservation4" id="reservation4" class="form-control" value="{{$tgls[3]}}" />
                      </div>
                      <span> What need to be done?<span class="required">*</span>
                      <div class="x_content">
                        <textarea name="descr4" id="descr4" required="required">{{$desc[3]}}</textarea>
                      </div>
                    </div>
                  </div>
                </div>
    ...
    <script type="text/javascript">
      CKEDITOR.replace( 'descr2' );
    </script>
    <script type="text/javascript">
      CKEDITOR.replace( 'descr3' );
    </script>
    <script type="text/javascript">
      CKEDITOR.replace( 'descr4' );
    </script>
...
@section ('custom_foot')
    ...
    <script type="text/javascript">
    var arr = [];
    var z = $("#sumOfGoods").val();
    var i = parseInt(z,10) + 1;
